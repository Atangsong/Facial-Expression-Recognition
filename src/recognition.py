...
def face_detect(img_path):
    ...
    face_cascade = cv2.CascadeClassifier(r'D:\Users\18755\Desktop\turanran-facial-expression-recognition5-master\facial-expression-recognition5\dataset\params\haarcascade_frontalface_alt.xml')
