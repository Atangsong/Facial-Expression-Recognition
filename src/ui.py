...
class UI(object):
    ...
    def retranslate_ui(self, form):
        ...
        self.label_designer.setText(_translate("Form", "2018217881"))
    ...
    def show_results(self, emotion, possibility):
        ...
        # 显示emoji
        if emotion != 'no':
            img = cv2.imread(r'D:\Users\18755\Desktop\turanran-facial-expression-recognition5-master\facial-expression-recognition5/assets/icons/' + str(emotion) + '.png')
